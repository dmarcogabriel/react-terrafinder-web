      ...
      <div className={classes.privacyPolicy}>
        ...
        <div className={classes.content}>
          <p>
            ...
            <Link to="www.terrafinder.com.br">Terrafinder</Link>, e outros sites
          ...
          <p>
            ...
            respectivas
            <Link to="https://politicaprivacidade.com" target="_blank">
          ...
          <h2>Política de Cookies Terrafinder</h2>
          ...
          <p>
            ...
            informação que o Terrafinder oferece no site e com caráter
          ...
          <ul>
            ...
            <li>
              ...
              xenofóbica,
              <Link to="https://ondeapostar.pt/">casas de apostas legais</Link>,
            ...
            <li>
              ...
              (softwares) do Terrafinder, de seus fornecedores ou terceiros, para
          ...
          <p>
            Esta política é efetiva a partir de <strong>Novembro</strong> de{' '}
            <strong>2020</strong>.
          </p>
        </div>
      </div>
